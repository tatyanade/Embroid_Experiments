...
// PARAMETERS
float _maxForce = 90; // Maximum steering force (oddly lowering this value seems to prevent 'equilibrium' type points)
float _maxSpeed = 10; // Maximum speed
float timeStep = .01;
float _desiredSeparation = 90;
float _separationCohesionRation = 1.01;
float _maxEdgeLen = 1;
