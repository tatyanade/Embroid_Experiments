//// IDEA:
//// place points along 3d arcs then project those onto a plane to flatten (maybe use something closer to a camera for projection) 
//// use the projected points to creat stitching paths
