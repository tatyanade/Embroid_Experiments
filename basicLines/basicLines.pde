...
void setup() {
  ...
  float theta =  0;
  PVector P0 = new PVector(width/4, height/2);
  PVector P1 = new PVector(0, -800).rotate(theta).add(P0);
  PVector P2 = new PVector(0, 800).rotate(theta).add(P0);
  E.stroke(180, 0, 0);
  E.setStitch(1,60,0);
 // E.line(P1.x, P1.y, P2.x, P2.y);
  E.stroke(0);
 // zigLine(E, P1, P2, 60, 1, 10);
 // zigLine(E, P2, P1, 60, 1, 10);

  P1.add(new PVector(width/4, 0));
  P2.add(new PVector(width/4, 0));
  E.stroke(180, 0, 0);
    E.setStitch(1,60,0);
  E.line(P1.x, P1.y, P2.x, P2.y);
  E.stroke(0);
  zigLine(E, P1, P2, 115, 1, 10);
  zigLine(E, P2, P1, 115, 1, 10);
  ...
  //E.line(P1.x, P1.y, P2.x, P2.y);
  E.stroke(0);
 // zigLine(E, P1, P2, 42, 1, 10);
 // zigLine(E, P2, P1, 42, 1, 10);
...
void zigLineStepLine(PEmbroiderGraphics E, PVector P0, PVector P1, float stWidth) { 
    zigLine(E, P0, P1, stWidth, 1, 10);
    filterND_stepOver(E, stWidth/2 - 40, stWidth/2);
