...
void setup() {
  size(1000, 1800); //100 px = 1 cm (so 14.2 cm is 1420px)
  PEmbroiderStart();
  E.stroke(255, 0, 0);
  E.stroke(0, 0, 255);
  drawDoublMossyCirlce(E, width/4, height/4, 1);
  
  drawDoublMossyCirlce(E, width/4*3, height/4, 2);
  
    drawDoublMossyCirlce(E, width/4, height/2, 1);
  
  drawDoublMossyCirlce(E, width/4*3, height/2, 2);
  
  drawDoublMossyCirlce(E, width/4, height/4*3, 3);
  
  drawDoublMossyCirlce(E, width/4*3, height/4*3, 4);
  filterReline(E);
...
void drawDoublMossyCirlce(PEmbroiderGraphics E, int x, int y, float z){
  PVector centOff = new PVector(random(-200,200),random(-200,200));
  E.stroke(int(random(255)),int(random(255)),int(random(255)));
  drawMossyCircle(E, x, y, 40, z, 20, 2,centOff);
  drawMossyCircle(E, x, y, 40, z, 10, 1.5,centOff);
  drawMossyCircle(E, x, y, 40, z, 0, 1,centOff);
}


///////////////////
void drawMossyCircle(PEmbroiderGraphics E, int x, int y, int diam2, float z, float zigOffset, float arLen,PVector centOff) {
  float filterTest = 4;
