...
void setup() {
  ...
  PVector P1 = new PVector(0, -350).rotate(theta).add(P0);
  PVector P2 = new PVector(0, 350).rotate(theta).add(P0);
  dowelStitch_withInteriorLace(E, P1, P2, 750);
...
void dowelStitch_withInteriorLace(PEmbroiderGraphics E, PVector P0, PVector P1, float stWidth) {
   ...
   E.strokeLocation(-.2);
    E.setStitch(1,20,0);
    E.beginOptimize();
    E.rect(P0.x,P0.y+340/2,stWidth,340);
    E.strokeWeight(0);
    E.endOptimize();
    E.noFill();
    ...
    zigLineCustom(E, P0, P0.copy().add(0,340), stWidth, 1, 5, 12);
...
void dowelStitch(PEmbroiderGraphics E, PVector P0, PVector P1){
  ...
  E.line(P0.x, P0.y, P1.x, P1.y);
  E.stroke(15);
  zigLine(E, P0, P1, dowelOffset-10, 1, 10);
  zigLine(E, P1, P0, dowelOffset-10, 1, 10);
}
